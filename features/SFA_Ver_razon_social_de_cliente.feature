...
@Test_dispositivo_1
Escenario: N°1 - Ver razón social
	Dado que se ingresó un cliente en el pedido
	Cuando el sistema disponibiliza los datos
	Entonces el sistema mostrará la razón social del cliente