...
Esquema del escenario: N°2 Ver avance del pedido mínimo
    ...
    Y el avance según suma de los montos de los pedidos para la misma fecha de entrega más el total del pedido en curso <sumaPedidos>
