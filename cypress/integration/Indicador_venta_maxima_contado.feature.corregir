...
@Pedido @Inidicador_maximo @Sprint8
...
Característica: Indicador venta máximo contado
    ...
    Quiero ver el avance de la venta de contado del cliente
    Para saber si le puedo registrar un pedido de contado
...
Esquema del escenario: N°1 - Ver avance de la venta de contado
    ...
    Y el <avance> según <montoContado> igual a venta máxima consumida para la fecha de entrega más la suma de los montos de los pedidos de contado registrados para la misma fecha de entrega más monto de los productos de contado del pedido en curso
