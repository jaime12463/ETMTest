...
Esquema del escenario: N°3 – Crear pedido en ruta con frecuencia abierta
...
Esquema del escenario: N°4 – El cliente no tiene visita programada en frecuencia
	Cuando <esFrecuenciaAbierta>  
...
Esquema del escenario: N°5 – El cliente está fuera de frecuencia
	Cuando <esFrecuenciaAbierta>  
