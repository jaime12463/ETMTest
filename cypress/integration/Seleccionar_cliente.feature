...
@Clientes @Validar_cliente @Sprint7 @Sprint8 @Srptin21
...
Escenario: N°8 - Limite de crédito excedido
    Dado que el cliente tiene excedido el límite de crédito
    Cuando se inicia la visita
    Entonces el sistema mostrará la pantalla de planeación
