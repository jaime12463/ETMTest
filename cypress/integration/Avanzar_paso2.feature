...
|     true		      |              false                |               true                       |              false        |             -              | Avisa que existen tarjetas vacias y que también se borrará el canje, con opcion a editar o avanzar. Si edita permanece en pantalla y se muestran las tarjetas de productos con cantidades en 0 con borde e inputs en rojo. Si avanza, borrará los productos y el canje ingresado                             |
|     true            |              false                |               true                       |              true         |             true           | Avisa que existen tarjetas vacias y que también se borrará el canje y se restablecerán las bonificaciones a cero, con opcion a editar o avanzar. Si edita permanece en pantalla y se muestran las tarjetas de productos con cantidades en 0 con borde e inputs en rojo. Si avanza, borrará los productos, el canje ingresado y se reestablecerán las bonificaciones  a cero    |
|     true            |              false                |               false				         |              false        |              -             | Avisa que existen tarjetas vacias, con opcion a editar o avanzar. Si edita permanece en pantalla y se muestran las tarjetas de productos con cantidades en 0 con borde e inputs en rojo. Si avanza, borrará los productos y no borrará las bonificaciones                                                                |
|     true            |              false                |               false                      |              true         |             true           | Avisa que existen tarjetas vacias y que también reestablecerán las bonificaciones a cero, con opcion a editar o avanzar. Si edita permanece en pantalla y se muestran las tarjetas de productos con cantidades en 0 con borde e inputs en rojo. Si avanza, borrará los productos y se reestablecerán las bonificaciones a cero |
|     -               |              -                    |                 -				         |                -          |             -              | Avisa que existen tarjetas vacias, con opcion a editar o avanzar. Si edita permanece en pantalla y se muestran las tarjetas de productos con cantidades en 0 con borde e inputs en rojo. Si avanza, borrará los productos                                                                                                    |
