...
Escenario: N°1 - Mostrar resumen
    ...
    Y se ingresaron productos al _tipoPedido cuyo _codigo = "Venta" con diferentes condiciones de pago
    Cuando selecciono ver resumen del pedido
    Entonces el sistema mostrará la fecha de entrega del pedido
    Y mostrará un listado de los productos ingresados separados por condición de pago, indicando código de producto,
    presentación, cantidad, precio unitario y subtotal de las subunidades 
    Y cantidad, precio unitario y subtotal de las unidades de cada producto
