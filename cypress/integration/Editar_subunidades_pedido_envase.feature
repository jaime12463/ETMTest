...
Escenario: N°1 – La cantidad es mayor a la disponible para retorno
	...
	Y la cantidad ingresada supera a la cantidad de subunidades actual de retorno + las cantidad de subunidades inicial de la celda que se está modificando 
...
Esquema del escenario: N°2 – La cantidad es menor o igual a la disponible para retorno
	...
	Y la cantidad ingresada no supera a la cantidad de subunidades actual de retorno + la cantidad de subunidades inicial de la celda que se está modificando 
