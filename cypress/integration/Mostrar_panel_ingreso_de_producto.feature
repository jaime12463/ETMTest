...
Escenario: N°1 - El tipo de pedido requiere motivo
    ...
    Entonces el sistema mostrará el producto, descripción, unidad, subunidad y el combo de selección de motivos vacíos.
...
Escenario: N°2 - El tipo de pedido no requiere motivo
    ...
    Cuando se encuentra habilitado el ingreso del producto
    Entonces el sistema mostrará el producto, descripción, unidad, subunidad, el precio unidad y el precio subunidad vacíos.