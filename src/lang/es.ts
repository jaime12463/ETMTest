const es = {
	general: {
		...
		no: 'No',
		noHayResultadosBusqueda: 'No existen resultados para tu búsqueda',
		nombre: 'Nombre',
		...
		verGrupo: 'Ver grupo',
		verRangosDescuentoEscalonado: 'Ver rangos de descuento escalonado',
		vigencia: 'Vigencia',
	},
	simbolos: {
		conDecimales: 'true',
	...
	advertencias: {
		...
		excedeMayorPermitido: 'El importe introducido supera el máximo permitido',
	...
	toast: {
		...
		promocionSinCantidadesMensaje:
			'La promoción que quieres aplicar se encuentra en ceros, debes ingresar cantidades para poder aplicarla.',
		promocionSinCantidadesTitulo: 'Promoción sin cantidades',
