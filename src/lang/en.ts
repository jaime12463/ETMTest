const en = {
	general: {
		...
		verGrupo: 'View group',
		verRangosDescuentoEscalonado: 'View staggered discount ranges',
		vigencia: 'Validity',
	},
	simbolos: {
		conDecimales: 'true',
	...
	advertencias: {
		...
		borrarPromosPush: 'All selected products will be deleted from Promotions.',
		borrarTodosTomaPedido:
			'Do you want to delete all products? All selected products will be deleted from the order inquiry.',
		...
		mensajeProductosSinCargarBonificacion:
			'If you advance to the next stage, the cards that have no amounts entered will be removed from your order socket along with the bonuses they contain.',
		mensajeProductosSinCargarCanje:
			'If you advance to the next stage, the cards that have no quantities entered will be removed from your order socket along with the redemptions they contain.',
		...
		productoAgregado: 'Product added correctly',
