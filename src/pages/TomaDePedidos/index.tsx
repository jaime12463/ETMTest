...
import {DetallePedido, Inicio} from '../../pages';
...
export default function TomaDePedidos() {
	...
	const buscarClienteEnDatos = useCallback(
		(codigoCliente: string): TCliente | undefined =>
	...
	const asignarPedidoActual = useCallback(
		(e: React.FormEvent) => {
			e.preventDefault();
			const clienteEncontrado: TCliente | undefined = buscarClienteEnDatos(
				codigoCliente
			);
									...
									<Grid container spacing={2}>
										...
										{existeCliente && (
											<Grid
												...
												xs={6}
												sm={6}
												className={estilos.sectionRazonSocial}
											>
                      ...
                      .split("T")[0]
											...
											<Grid item xs={12} sm={12}>
												<InputTexto
													...
													autoFocus={
														preciosProductos && !productoActual.codigoProducto
													}
